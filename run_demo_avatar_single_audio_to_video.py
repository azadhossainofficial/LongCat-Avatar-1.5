...
def generate(args):
    ...
    if use_distill and model_type == "avatar-v1.5":
        ...
        audio_guidance_scale = getattr(args, 'audio_guidance_scale', 0.9) if getattr(args, 'audio_guidance_scale', None) is not None else 0.9
